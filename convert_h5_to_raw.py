...
def convert_two_hit_tables(input_filename, output_filename, h5_file_num):
    ...
    with tb.open_file(input_filename, 'r') as in_file_h5:
        ...
        for index, hit in enumerate(hits):
            ...
            myExtraCalc.x = (int(hit['column']) - 1) * 0.25
            myExtraCalc.y = - (int(hit['row']) - 1) * 0.05
            myExtraCalc.z = 12.5
...
if __name__ == "__main__":
    path_to_file = '/home/pixel/pybar/tags/2.0.2/host/pybar/module_test'
    h5_file_num = 745
    ...
    convert_two_hit_tables(path_to_file + '/' + str(h5_file_num) + '_module_test_stop_mode_ext_trigger_scan_interpreted.h5', path_to_file + '/' + str(h5_file_num) + '_module_test_stop_mode_ext_trigger_scan_interpreted_raw.root', h5_file_num)
